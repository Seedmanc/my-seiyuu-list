...
angular.module('myApp', [])
	...
	.controller('myCtrl', function ($scope) {
		...
		function updatePics() {
			...
			$('#photos-spinner').show();
			$('#thumbContainer').hide();
			$('#thumbContainer').load('https://crossorigin.me/http://koe.booru.org/index.php'+encodeURIComponent('?page=post&s=list&tags=' + tags + '&pid=') + pid + ' div.content span.thumb',
		...
		function gotPics(tags, status, xhr) {
			...
			if (thumbs.length == 0 && ~tags.indexOf('solo')) {
				$('#photos-spinner').show();
				$('#thumbContainer').hide();
				$('#thumbContainer').load('https://crossorigin.me/http://koe.booru.org/index.php'+encodeURIComponent('?page=post&s=list&tags=' + tags.replace('+solo', '') + '&pid=') + pid + ' div.content span.thumb', function (response, status, xhr) {
					$('#photos-spinner').hide();
					$('#thumbContainer').show();
